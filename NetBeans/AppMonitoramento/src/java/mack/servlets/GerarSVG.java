 ...
 * @author 41486501
 */
public class GerarSVG extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            Source xmlSource = new StreamSource("/temp/dados/monitoramento.xml");
            ...
            Logger.getLogger(GerarSVG.class.getName()).log(Level.SEVERE, null, ex);
